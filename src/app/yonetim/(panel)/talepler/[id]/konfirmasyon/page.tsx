...
export default async function KonfirmasyonPage({
  ...
  const booking = await getBookingForConfirmation(id);
  if (!booking) notFound();
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mt-5 rounded-2xl border border-sand-200 bg-white p-5 print:border-none print:p-0 print:shadow-none">
        ...
        <div className="mt-5 space-y-3 border-t border-sand-100 pt-4 text-sm leading-relaxed text-brand-900/80">
          <p>
            <strong>Depozito prosedürü:</strong> Hasar depozitosu girişten
            önce tahsil edilir, çıkışta villada hasar/kayıp yoksa aynen iade
            edilir. Hasar veya eksik eşya durumunda tutar depozitodan
            karşılanır.
          </p>
          <p>
            <strong>Giriş/çıkış:</strong> Yeni misafirlerimize villalar{" "}
            ...
            {booking.villa ? shortTime(booking.villa.checkOutTime) : "10:00"}
